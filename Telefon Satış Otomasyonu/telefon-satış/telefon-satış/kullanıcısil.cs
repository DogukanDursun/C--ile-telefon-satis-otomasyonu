...
{
    public partial class kullanıcısil : MetroFramework.Forms.MetroForm
    {
        public kullanıcısil()
        {
            InitializeComponent();
        ...
        void griddoldur()
        {
            ...
            da = new SqlDataAdapter("Select *From müsteri", bag);
            ds = new DataSet();
            bag.Open();
            da.Fill(ds, "müsteri");
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                bag.Open();
                SqlCommand komut = new SqlCommand("delete from müsteri where İd='" + dataGridView1.SelectedRows[i].Cells["İd"].Value.ToString() + "'", bag);
